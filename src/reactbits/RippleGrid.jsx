/*
 * RippleGrid — adapted from React Bits (https://reactbits.dev) by David Haz.
 * License: MIT + Commons Clause · https://github.com/DavidHDev/react-bits
 *
 * The render loop is gated behind IntersectionObserver + visibilitychange —
 * the original runs requestAnimationFrame forever regardless of whether the
 * canvas is on-screen or the tab is backgrounded.
 */
...
void main() {
    ...
    // only spend GPU/CPU on this while it's actually visible on screen and the tab is foregrounded
