...
export const projects = [
  ...
  },
  {
    ...
    tags: ["Power BI", "Python", "Data Modeling", "110K+ records", "Risk Scoring"],
    tint: "tint-b",
  ...
  },
  {
    ...
    desc: "「千模百炼」全国 AI 开发者学生赛道参赛作品(阿里云百炼)。基于阿里云百炼 QwenPaw 平台为澳门独居长者设计主动守护的多智能体系统,覆盖有网、无网、零网络三类场景。负责 AI Prompt 多智能体交互脚本设计与家属端数据可视化 PWA 开发。",
  ...
  },
  {
    ...
    tags: ["PPT/Excel", "Valuation", "Fundamentals", "Equity Research"],
    tint: "tint-c",
  ...
  },
  {
    ...
    tags: ["Excel / SPSS", "Regression", "n = 11,379", "Adj. R² = .183"],
    tint: "tint-d",
